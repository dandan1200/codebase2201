...
public class Ball {
    ...
    public Ball(String colour, double xPosition, double yPosition, double xVelocity, double yVelocity, double mass,
            boolean isCue, PocketStrategy strategy, PointsStrategy pointsStrategy) {
    ...
    public int getPoints() {
        return this.pointsStrategy.getPoints();
    }

    public Ball clone() {
        return new Ball(this.colour.toString(), xPosition, yPosition, xVelocity, yVelocity, mass, isCue, strategy.clone(), pointsStrategy);
    }
